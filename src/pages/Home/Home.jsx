    ...
    return (
        <div id="home" className="h-min lg:max-h-screen w-full flex justify-center items-center">
            <div>
                ...
                <div className='absolute w-full h-60 left-[430px] sm:left-[500px] md:left-[300px] lg:left-[1300px] pt-[250px] sm:pt-[300px] md:pt-[300px] lg:pt-[380px] rotate-12'>
                    <div className='w-20 sm:w-40 md:w-56 lg:w-52 h-w-20 sm:h-40 md:h-56 lg:h-w-52'>
                        <iframe className='w-full h-full' src="https://lottie.host/embed/3e0bce21-477f-458b-b1c5-386e993a5e83/iktcQKtbu5.json"></iframe>
                    </div>
                </div>
